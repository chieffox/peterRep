...
$(document).ready(function() {
  ...
  //   $("body").append("<div class='mouseshiyi'><div class='mouseshiyia'><img class='img1' src='../web/assets/images/mouseKey.gif'><img class='img2' src='../web/assets/images/mouseKeya.gif'><img class='img3' src='../web/assets/images/tip.png'></div></div>")
  //   var shudscin = 0;
  ...
  $(".r-slide-nav .nav2").click(function() {
  ...
  $(".liaoJie_list ul li .ruad").each(function(index, element) {
    ...
    if (index == 2) {
      $(this).html("<span><b><img src='images/numberImg.png'><img class='imgsa' src='images/numberImg.png'></b><b class='yuan'>" + thisImg + "</b></span>")
    } else if (index == 3) {
      $(this).html("<span><b><img src='images/numberImg.png'><img class='imgsa' src='images/numberImg.png'></b><b><img src='images/numberImg.png'><img class='imgsa' src='images/numberImg.png'></b><b><img src='images/numberImg.png'><img class='imgsa' src='images/numberImg.png'></b><b class='yuan'>" + thisImg + "</b></span>")
    } else if (index == 1) {
      $(this).html("<span><b><img src='images/numberImg.png'><img class='imgsa' src='images/numberImg.png'></b><b><img src='images/numberImg.png'><img class='imgsa' src='images/numberImg.png'></b><b><img src='images/numberImg.png'><img class='imgsa' src='images/numberImg.png'></b><b class='yuan'>" + thisImg + "</b></span>");
    } else {
      $(this).html("<span><b><img src='images/numberImg.png'><img class='imgsa' src='images/numberImg.png'></b><b><img src='images/numberImg.png'><img class='imgsa' src='images/numberImg.png'></b><b class='yuan'>" + thisImg + "</b></span>")
    }
  });
  ///////我们的服务滑入效果/////////
  ...
  function divscrollTopAE() {
    ...
    function bankScrollSCSE() {
      ...
      if (windowWIdh > windowheights && windowWIdh > 1000) {
        $(".bankScroll").height(windowheights).css({
          padding: 0
        });
        ...
        $(".liaoJie_list ul li .ruad span b").eq(0).find("img").css({
          top: -68 * 1
        });
        $(".liaoJie_list ul li .ruad span b").eq(1).find("img").css({
          top: -68 * 1
        });
        $(".liaoJie_list ul li .ruad span b").eq(3).find("img").css({
          top: -68 * 1
        });
        $(".liaoJie_list ul li .ruad span b").eq(4).find("img").css({
          top: -68 * 5
        });
        $(".liaoJie_list ul li .ruad span b").eq(5).find("img").css({
          top: -68 * 0
        });
        $(".liaoJie_list ul li .ruad span b").eq(7).find("img").css({
          top: -68 * 4
        });
        $(".liaoJie_list ul li .ruad span b").eq(9).find("img").css({
          top: -68 * 8
        });
        $(".liaoJie_list ul li .ruad span b").eq(10).find("img").css({
          top: -68 * 0
        });
        $(".liaoJie_list ul li .ruad span b").eq(11).find("img").css({
          top: -68 * 0
        });
      }
    }
        ...
        if (mouseWheelis == true) {
          ...
          if (deltaY < 0 && bankScroll_index < bankScroll_leng - 1) {
            ...
            $("html,body").stop().animate({
              scrollTop: bankScroll_index * windowHt
            },
            800, "easeInOutCubic")
          }
          ...
          if (bankScroll_index == 3 && $(".liaoJie_list ul li .ruad span b.yuan").length > 0) {
            $(".liaoJie_list ul li .ruad span b img").css({
              top: 0
            });
            setTimeout(function() {
              $(".liaoJie_list ul li .ruad span b").eq(0).find("img").stop().animate({
                top: -68 * 1 - 680
              },
              500, "easeOutCubic");
              $(".liaoJie_list ul li .ruad span b").eq(1).find("img").stop().animate({
                top: -68 * 1 - 680
              },
              700, "easeOutCubic");
              $(".liaoJie_list ul li .ruad span b").eq(3).find("img").stop().animate({
                top: -68 * 1 - 680
              },
              800, "easeOutCubic");
              $(".liaoJie_list ul li .ruad span b").eq(4).find("img").stop().animate({
                top: -68 * 5 - 680
              },
              900, "easeOutCubic");
              $(".liaoJie_list ul li .ruad span b").eq(5).find("img").stop().animate({
                top: -68 * 0 - 680
              },
              900, "easeOutCubic");
              $(".liaoJie_list ul li .ruad span b").eq(7).find("img").stop().animate({
                top: -68 * 4 - 680
              },
              1000, "easeOutCubic");
              $(".liaoJie_list ul li .ruad span b").eq(9).find("img").stop().animate({
                top: -68 * 8 - 680
              },
              1500, "easeOutCubic");
              $(".liaoJie_list ul li .ruad span b").eq(10).find("img").stop().animate({
                top: -68 * 0 - 680
              },
              1700, "easeOutCubic");
              $(".liaoJie_list ul li .ruad span b").eq(11).find("img").stop().animate({
                top: -68 * 0 - 680
              },
              1700, "easeOutCubic");
            },
  ...
  $(window).scroll(function() {
    ...
    $(".backImgsClassA,.backImgsClassB,.backImgsClassC,.backImgsClassD").each(function(index, element) {
      $(this).css({
        top: Math.max($(this).parents(".bankScroll").offset().top - $(window).scrollTop() - windhsoueght, -windhsoueght) / 10
      });
    });
  })
  /////////返回顶部////////
  $(".r-slide-nav a:last").click(function() {
    $("html,body").animate({
      scrollTop: 0
    },
    500, "easeInOutCubic");
